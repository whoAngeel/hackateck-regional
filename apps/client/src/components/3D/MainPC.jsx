          ...
          <Canvas camera={{ position: [0, 0, 2.5] }}>
            ...
            <Suspense fallback={null}>
              <mesh position={[-2.1, 0, 0.5]}>
                ...
                <Text
                  position={[0, 0.8, 0.15]} // Ajusta la posición del texto en la malla
                ...
                <Text
                  position={[0, 0.6, 0.15]} // Ajusta la posición del texto en la malla
                ...
                <Text
                  position={[0, 0.5, 0.15]} // Ajusta la posición del texto en la malla
                  fontSize={0.06} // Tamaño del texto
                  color="#ffffff" // Color del texto
                  anchorX="center" // Alineación horizontal
                  anchorY="middle" // Alineación vertical
                ...
                <Text
                  position={[0, 0.4, 0.15]} // Ajusta la posición del texto en la malla
                  fontSize={0.06} // Tamaño del texto
                  color="#ffffff" // Color del texto
                  anchorX="center" // Alineación horizontal
                  anchorY="middle" // Alineación vertical
                ...
                <Text
                  position={[0, 0.3, 0.15]} // Ajusta la posición del texto en la malla
                  fontSize={0.06} // Tamaño del texto
                  color="#ffffff" // Color del texto
                  anchorX="center" // Alineación horizontal
                  anchorY="middle" // Alineación vertical
